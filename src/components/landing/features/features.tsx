    ...
    return (
        <section className={"px-20 max-sm:px-5 py-5"}>
            <div className={"grid grid-cols-3 max-lg:grid-cols-2 max-md:grid-cols-1 gap-5 w-3/4 max-xl:w-full mx-auto"}>
                <Card className={"bg-gradient-to-tr from-primary to-black text-white hover:bg-linear-120 hover:scale-105 transition-all duration-300 cursor-pointer  dark:border-none"}>
